set -x
cd $home/Downloads/vmware-tools-distrib/lib/modules/source
...
sudo patch -p0 <$home/Downloads/vmhgfs-d_count-kernel-3.11-tools-9.6.0.patch
sudo mv vmhgfs.tar vmhgfs.orig.tar
sudo tar cf vmhgfs.tar vmhgfs-only
cd $home/Downloads/vmware-tools-distrib
